	...
	<div class="px-3 md:py-5 md:px-6 flex flex-col justify-center w-full min-h-screen bg-[#f5bdc1]">
        ...
        bg-no-repeat bg-cover"></div>
			...
			<div class="col-span-1 pt-5 md:pt-18 px-5 md:px-5 lg:px-20">
				...
				<div class="py-3"></div>
				<form>
					<label for="username" class="block pb-1">USERNAME/EMAIL</label>
					...
					<div class="py-3 md:py-2"></div>
					<a href="<?= url_to('beranda-member') ?>" class="block w-full py-3 md:py-2 border-2 border-solid border-blue-500 bg-blue-500 text-white text-center rounded-lg
            cursor-pointer">
						Masuk
					</a>
					<div class="py-2.5 md:py-1.5"></div>
					<button type="button" class="flex items-center justify-center gap-3 bg-white border border-gray-300 text-gray-700 font-medium py-3 md:py-2 px-4 rounded-lg 
              hover:bg-gray-50 hover:shadow-md transition-all duration-200 ease-in-out w-full cursor-pointer">
					...
					<a href="<?= url_to('registrasi') ?>" class="block w-full py-3 md:py-2 border border-gray-300 text-center rounded-md">Buat Akun</a>
					<div class="py-6"></div>
				</form>
			</div>
			<!--/ Form -->
