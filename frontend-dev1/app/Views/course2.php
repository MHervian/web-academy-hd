...
<head>
	<title>Course Pelatihan Guru Bahasa Korea - DreamTemplate</title>
	<!-- Required meta tags -->
	<meta charset="utf-8" />
	...
	<header class="bg-gradient" id="beranda">
		<div class="container mt-5">
			<div class="row">
				<div class="col-12">
					<div class="text-left">
						<h1>Pelatihan Guru Bahasa Korea</h1>
						<p class="tagline mx-0">
							Program belajar dan pelatihan menjadi guru bahasa korea yang tersertifikasi.
						</p>
					</div>
				</div>
			</div>
		...
		<div class="row my-5">
			...
			<div class="col-3">
				<div class="text-left">
					...
					<ul>
						<li><a href="<?= url_to('coming-soon') ?>">Kurikulum 2025</a></li>
						<li><a href="<?= url_to('coming-soon') ?>">Kurikulum 2020</a></li>
						<li><a href="<?= url_to('coming-soon') ?>">Kurikulum 2015</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="row my-5">
			...
			<div class="col-3">
				<div class="text-left">
					...
					<ul>
						<li><a href="<?= url_to('coming-soon') ?>">10 Agustus - 30 September</a></li>
						<li><a href="<?= url_to('coming-soon') ?>">09 Mei - 30 Juni</a></li>
					</ul>
				</div>
			</div>
		</div>
