...
CREATE TABLE `private_user` (
  ...
  `lvl` enum('0','1','2') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`userId`)
...
INSERT INTO `private_user` VALUES (1,'cnadmin','$2y$10$UI2hmmAwyNSTdJd/Mh5rM.9IGg3S1rQQNUi0j8pqkVf54/X0C3sry','2025-09-18 08:47:52','0');
