        ...
        <div class="main">
            ...
            <div class="content">
                <div class="card-form">
                    ...
                    <form>
                        <label for="class">Nama Kurikulum</label>
                        ...
                        <select id="student" name="student">
                            ...
                            <option value="s1">Novice</option>
                            <option value="s2">Beginner</option>
                            <option value="s3">Intermediate</option>
                            <option value="s3">Expert</option>
